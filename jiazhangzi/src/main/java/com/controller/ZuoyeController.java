    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        if(false)
            ...
            JiazhangxueshengEntity jiazhangxueshengEntity = jiazhangxueshengService.selectById((Integer) request.getSession().getAttribute("userId"));
            params.put("jiazhangxueshengId",request.getSession().getAttribute("userId"));
            params.put("banjiTypes",jiazhangxueshengEntity.getBanjiTypes());
        }
