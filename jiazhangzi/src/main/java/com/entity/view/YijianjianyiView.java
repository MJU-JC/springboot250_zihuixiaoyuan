...
public class YijianjianyiView extends YijianjianyiEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 意见建议类型的值
		*/
		private String yijianjianyiValue;
	...
	public YijianjianyiView() {

	}

	public YijianjianyiView(YijianjianyiEntity yijianjianyiEntity) {
		try {
			BeanUtils.copyProperties(this, yijianjianyiEntity);
			...
			* 获取： 意见建议类型的值
			*/
			public String getYijianjianyiValue() {
				return yijianjianyiValue;
			}
			/**
			* 设置： 意见建议类型的值
			*/
			public void setYijianjianyiValue(String yijianjianyiValue) {
				this.yijianjianyiValue = yijianjianyiValue;
			}
