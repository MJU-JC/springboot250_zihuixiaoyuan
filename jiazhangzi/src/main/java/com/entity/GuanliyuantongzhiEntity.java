...
public class GuanliyuantongzhiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public GuanliyuantongzhiEntity() {

	}

	public GuanliyuantongzhiEntity(T t) {
		try {
     ...
     * 管理员通知名称
     */
    @TableField(value = "guanliyuantongzhi_name")
     ...
     * 管理员通知类型
     */
    @TableField(value = "guanliyuantongzhi_types")
     ...
     * 管理员通知内容
     */
    @TableField(value = "guanliyuantongzhi_content")
    ...
    public String toString() {
        return "Guanliyuantongzhi{" +
            "id=" + id +
            ", jiazhangxueshengId=" + jiazhangxueshengId +
            ", guanliyuantongzhiName=" + guanliyuantongzhiName +
            ", guanliyuantongzhiTypes=" + guanliyuantongzhiTypes +
            ", guanliyuantongzhiContent=" + guanliyuantongzhiContent +
