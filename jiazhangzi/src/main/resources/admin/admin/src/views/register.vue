<template>
    <div style="backgroundImage: url('/jiazhangzi/img/back-img-bg.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">智慧校园之家长子系统注册</h1>
                <el-form class="rgs-form" label-width="120px">
                        ...
                        <el-form-item label="家长联系方式" class="input" v-if="tableName=='jiazhangxuesheng'">
                            <el-input v-model="ruleForm.jiazhangxueshengPhone" autocomplete="off" placeholder="家长联系方式"  />
                        </el-form-item>
                        <el-form-item label="学生身份证号" class="input" v-if="tableName=='jiazhangxuesheng'">
                            <el-input v-model="ruleForm.jiazhangxueshengIdNumber" autocomplete="off" placeholder="学生身份证号"  />
                        </el-form-item>
                        <el-form-item label="联系邮箱" class="input" v-if="tableName=='jiazhangxuesheng'">
                            <el-input v-model="ruleForm.jiazhangxueshengEmail" autocomplete="off" placeholder="联系邮箱"  />
                        </el-form-item>
        ...
        methods: {
            ...
            login() {
                            ...
                            if('jiaoshi' == this.tableName && this.ruleForm.jiaoshiEmail&&(!this.$validate.isEmail(this.ruleForm.jiaoshiEmail))){
                             ...
                             if('jiazhangxuesheng' == this.tableName && this.ruleForm.jiazhangxueshengPhone&&(!this.$validate.isMobile(this.ruleForm.jiazhangxueshengPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.jiazhangxueshengIdNumber)&& 'jiazhangxuesheng'==this.tableName){
                                this.$message.error('学生身份证号不能为空');
                                return
                            }
                            if('jiazhangxuesheng' == this.tableName && this.ruleForm.jiazhangxueshengEmail&&(!this.$validate.isEmail(this.ruleForm.jiazhangxueshengEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                this.$http({
